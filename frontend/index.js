...
(function($PS) {
  ...
  var inferSlug = function (dictMonadEffect) {
      var toSlug = function (p) {
          ...
          throw new Error("Failed pattern match at Blog (line 245, column 6 - line 247, column 29): " + [ p.constructor.name ]);
      };
      return Control_Bind.composeKleisli((dictMonadEffect.Monad0()).Bind1())(Router.path(dictMonadEffect))((function () {
          var $78 = Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0());
          return function ($79) {
              return $78(toSlug($79));
          };
      })());
  ...
  var getArticleContent = function (dictMonadAff) {
      return function (v) {
          return Effect_Aff_Class.liftAff(dictMonadAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.bimap(Data_Bifunctor.bifunctorEither)(Affjax.printError)(function ($80) {
      ...
      return function (slug) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              if (article instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Blog (line 220, column 37 - line 222, column 43): " + [ article.value0.content.constructor.name ]);
              };
              if (article instanceof Data_Maybe.Nothing) {
                  return noSuchArticle("no such article: " + Data_Show.show(showSlug)(slug));
              };
              throw new Error("Failed pattern match at Blog (line 219, column 5 - line 223, column 66): " + [ article.constructor.name ]);
          });
      };
  };
  ...
  var blogComponent = function (dictMonadAff) {
      ...
      var renderBlogList = function (state) {
          ...
          throw new Error("Failed pattern match at Blog (line 160, column 3 - line 164, column 74): " + [ state.constructor.name ]);
      };
      ...
      var render = function (v) {
          ...
          throw new Error("Failed pattern match at Blog (line 112, column 26 - line 114, column 35): " + [ v.value0.currentArticle.constructor.name ]);
      };
...
(function($PS) {
  ...
  var filePathToLi = function (isOdd) {
      return function (path) {
          ...
          return Halogen_HTML_Elements.li([ HTMLHelper.cl([ "browse-content-item-" + (function () {
              if (isOdd) {
                  return "odd";
              };
              return "even";
  ...
  var renderedFiles = (function () {
      var $16 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return v.html;
      });
      var $17 = Data_Array.sortBy(Data_Ord.comparing(Data_Ord.ordString)(function (v) {
          return v.path;
      }));
      var $18 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      var $19 = Data_Foldable.foldl(Data_Set.foldableSet)(function (v) {
          return function (path) {
              return {
                  b: !v.b,
                  lis: new Data_List_Types.Cons({
                      html: filePathToLi(v.b)(path),
                      path: path
                  }, v.lis)
              };
          };
  ...
  var browseComponent = function (dictMonadAff) {
      var render = function (files) {
          var subSection = function (s) {
              return function (t) {
                  return function (l) {
                      return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.id("browse-" + s), HTMLHelper.cl([ "browse-content" ]) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(t) ]), Halogen_HTML_Elements.ul_(renderedFiles(l)) ]);
                  };
              };
          };
          return Halogen_HTML_Elements.section([ HTMLHelper.cl([ "container", "section", "content" ]) ])([ subSection("images")("Images")(files.pubImages), subSection("executables")("Executables")(files.pubExecutables), subSection("videos")("Videos")(files.pubVideos), subSection("archives")("Archives")(files.pubArchives), subSection("audios")("Audios")(files.pubAudios), subSection("texts")("Texts")(files.pubTexts), subSection("papers")("Papers")(files.pubPapers), subSection("unknown")("Unknown")(files.pubUnknown) ]);
      };
      var initialState = function (v) {
          return {
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
              ...
              if (resp instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(resp.value0);
              };
              throw new Error("Failed pattern match at Browse (line 77, column 7 - line 79, column 33): " + [ resp.constructor.name ]);
          });
      };
      var $$eval = Halogen_Component.mkEval({
          handleAction: handleAction,
