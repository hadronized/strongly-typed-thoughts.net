...
(function($PS) {
  ...
  var inferSlug = function (dictMonadEffect) {
      var toSlug = function (p) {
          ...
          throw new Error("Failed pattern match at Blog (line 247, column 6 - line 249, column 29): " + [ p.constructor.name ]);
      };
      ...
      return function (slug) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              if (article instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Blog (line 222, column 37 - line 224, column 43): " + [ article.value0.content.constructor.name ]);
              };
              if (article instanceof Data_Maybe.Nothing) {
                  return noSuchArticle("no such article: " + Data_Show.show(showSlug)(slug));
              };
              throw new Error("Failed pattern match at Blog (line 221, column 5 - line 225, column 66): " + [ article.constructor.name ]);
          });
      };
  };
  ...
  var blogComponent = function (dictMonadAff) {
      ...
      var renderBlogList = function (state) {
          ...
          throw new Error("Failed pattern match at Blog (line 159, column 3 - line 163, column 74): " + [ state.constructor.name ]);
      };
      ...
      var render = function (v) {
          ...
          throw new Error("Failed pattern match at Blog (line 111, column 26 - line 113, column 35): " + [ v.value0.currentArticle.constructor.name ]);
      };
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Blog (line 83, column 7 - line 97, column 100): " + [ response.constructor.name ]);
                  })())(function () {
          ...
          throw new Error("Failed pattern match at Blog (line 79, column 18 - line 103, column 41): " + [ v.constructor.name ]);
      };
