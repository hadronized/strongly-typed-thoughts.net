...
(function($PS) {
  ...
  var showSlug = new Data_Show.Show(function (v) {
      return v;
  });
                  ...
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Formatter_DateTime.unformatDateTime("YYYY-MM-DDTHH:mm:ssZ")(publishDateRaw))(function (publishDate) {
                      return Control_Bind.bind(Data_Either.bindEither)($$JSON.extractField(o)("missing article tags")("tags")(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toArray)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Argonaut_Core.toString))))(function (tags) {
                          return Control_Bind.bind(Data_Either.bindEither)($$JSON.extractField(o)("missing article slug")("slug")((function () {
                              var $79 = Data_Functor.map(Data_Maybe.functorMaybe)(Slug);
                              return function ($80) {
  ...
  var inferSlug = function (dictMonadEffect) {
      var toSlug = function (p) {
          ...
          throw new Error("Failed pattern match at Blog (line 248, column 6 - line 250, column 29): " + [ p.constructor.name ]);
      };
      return Control_Bind.composeKleisli((dictMonadEffect.Monad0()).Bind1())(Router.path(dictMonadEffect))((function () {
          var $81 = Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0());
          return function ($82) {
              return $81(toSlug($82));
          };
      })());
  ...
  var getArticleContent = function (dictMonadAff) {
      return function (v) {
          return Effect_Aff_Class.liftAff(dictMonadAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.bimap(Data_Bifunctor.bifunctorEither)(Affjax.printError)(function ($83) {
  ...
  var readArticle = function (dictMonadAff) {
      return function (slug) {
          var switchToArticle = function (metadata) {
              return function (html) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                      return new State({
                          articles: v.value0.articles,
                          currentArticle: new Data_Maybe.Just({
                              html: html,
                              metadata: metadata
                          }),
                          router: v.value0.router
          ...
          var cache = function (metadata) {
              return function (html) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                      ...
                      return switchToArticle(metadata)(html);
                  });
              };
          };
        
          // read and cache, then switch
  var cacheAndSwitch = function (metadata) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getArticleContent(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(slug))(Data_Either.either(noSuchArticle)(cache(metadata)));
          };
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              return Data_Map_Internal.lookup(ordSlug)(slug)(v.value0.articles);
          }))(function (article) {
              if (article instanceof Data_Maybe.Just) {
                  if (article.value0.content instanceof Data_Maybe.Just) {
                      return switchToArticle(article.value0.metadata)(article.value0.content.value0);
                  };
                  if (article.value0.content instanceof Data_Maybe.Nothing) {
                      return cacheAndSwitch(article.value0.metadata);
                  };
                  throw new Error("Failed pattern match at Blog (line 223, column 37 - line 225, column 43): " + [ article.value0.content.constructor.name ]);
              };
              if (article instanceof Data_Maybe.Nothing) {
                  return noSuchArticle("no such article: " + Data_Show.show(showSlug)(slug));
              };
              throw new Error("Failed pattern match at Blog (line 222, column 5 - line 226, column 66): " + [ article.constructor.name ]);
          });
      };
  };
  ...
  var blogComponent = function (dictMonadAff) {
      var renderArticle = function (metadata) {
          return function (html) {
              return Halogen_HTML_Elements.section([ HTMLHelper.cl([ "container", "section" ]) ])([ Halogen_HTML_Elements.h1([ HTMLHelper.cl([ "title" ]) ])([ Halogen_HTML_Core.text(metadata.name) ]), Halogen_HTML_Elements.h2([ HTMLHelper.cl([ "subtitle" ]) ])([ Halogen_HTML_Elements.em_([ Halogen_HTML_Core.text(Data_String_Common.joinWith(", ")(metadata.tags)) ]) ]), Halogen_HTML_Elements.h2([ HTMLHelper.cl([ "subtitle" ]) ])([ Halogen_HTML_Core.text(formatTime(metadata.publishDate)), Halogen_HTML_Core.text(", by Dimitri Sabadie \u2013 "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/blog/feed") ])([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "icon", "rss-feed" ]) ])([ Halogen_HTML_Elements.i([ HTMLHelper.cl([ "fa", "fa-rss" ]) ])([  ]) ]), Halogen_HTML_Core.text(" feed") ]) ]), Halogen_HTML_Elements.hr_, Halogen_HTML_Elements.div([ HTMLHelper.cl([ "content", "blog-content" ]) ])([ Halogen_HTML.fromPlainHTML(html) ]) ]);
          };
      };
      ...
      var handleQuery = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Router.setPath(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(router)("/blog"))(function () {
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Blog (line 84, column 7 - line 98, column 100): " + [ response.constructor.name ]);
                  })())(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.value0.router;
                      }))(function (router) {
          ...
          throw new Error("Failed pattern match at Blog (line 80, column 18 - line 104, column 41): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var FilterFiles = (function () {
      function FilterFiles(value0) {
          this.value0 = value0;
      };
      FilterFiles.create = function (value0) {
          return new FilterFiles(value0);
      };
      return FilterFiles;
  })();
  ...
  var renderedFiles = function (fileFilter) {
      var fileFilter$prime = Data_String_Common.toLower(fileFilter);
      var $22 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return v.html;
      });
      var $23 = Data_Array.sortBy(Data_Ord.comparing(Data_Ord.ordString)(function (v) {
          return v.name;
      }));
      var $24 = Data_Array.filter(function (s) {
          return Data_String_Utils.includes(fileFilter$prime)(Data_String_Common.toLower(s.name));
      });
      var $25 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      var $26 = Data_Foldable.foldl(Data_Set.foldableSet)(function (v) {
          return function (path) {
              return {
                  b: !v.b,
                  lis: new Data_List_Types.Cons(filePathToLi(v.b)(path), v.lis)
              };
          };
      })({
          b: true,
          lis: Data_List_Types.Nil.value
      });
      return function ($27) {
          return $22($23($24($25((function (v) {
              return v.lis;
          })($26($27))))));
      };
  };
  var browseComponent = function (dictMonadAff) {
      var render = function (state) {
          var subSection = function (fileFilter) {
              return function (s) {
                  return function (t) {
                      return function (l) {
                          var rendered = renderedFiles(fileFilter)(l);
                          var $13 = Data_Array["null"](rendered);
                          if ($13) {
                              return Data_Maybe.Nothing.value;
                          };
                          return Data_Maybe.Just.create(Halogen_HTML_Elements.section([ Halogen_HTML_Properties.id("browse-" + s), HTMLHelper.cl([ "browse-content" ]) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(t) ]), Halogen_HTML_Elements.ul_(renderedFiles(fileFilter)(l)) ]));
                      };
                  };
              };
          };
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
                  return parseUploadedFiles(res.body);
              })(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Affjax.printError)))(Affjax.get(Affjax_ResponseFormat.json)(API.endpoint("/browse")))))(function (resp) {
                  if (resp instanceof Data_Either.Left) {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(resp.value0));
                  };
