...
(function($PS) {
  ...
  var blogComponent = function (dictMonadAff) {
      var render = function (v) {
          return Halogen_HTML_Elements.section([ HTMLHelper.cl([ "container", "section", "content" ]) ])([ Halogen_HTML_Elements.h1([ HTMLHelper.cl([ "title" ]) ])([ Halogen_HTML_Elements.b_([ Halogen_HTML_Core.text("Dimitri Sabadie") ]), Halogen_HTML_Core.text("\u2019s blog") ]), Halogen_HTML_Elements.h2([ HTMLHelper.cl([ "subtitle" ]) ])([ Halogen_HTML_Elements.em_([ Halogen_HTML_Core.text("Functional programming, graphics, demoscene and more!") ]) ]), Halogen_HTML_Elements.hr_, Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("This is my blog. I talk about functional programming, graphics, demoscene, optimization and many other topics!") ]), Halogen_HTML_Elements.blockquote_([ Halogen_HTML_Core.text("It is intentional that no comment can be written by readers to prevent flooding, scams and spamming.") ]), Halogen_HTML_Elements.hr_, Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Feel free to subscribe to the "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/blog/feed") ])([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "icon", "rss-feed" ]) ])([ Halogen_HTML_Elements.i([ HTMLHelper.cl([ "fa", "fa-rss" ]) ])([  ]) ]), Halogen_HTML_Core.text("feed") ]), Halogen_HTML_Core.text(" to be notified when a new article is released!") ]), Halogen_HTML_Elements.hr_ ]);
      };
      var initialState = function (v) {
          return Data_Unit.unit;
      };
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.json)("/api/v1/blog")))(function (response) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))((function () {
                  if (response instanceof Data_Either.Left) {
                      return Effect_Class_Console.log(Effect_Class.monadEffectEffect)(Affjax.printError(response.value0));
                  };
                  if (response instanceof Data_Either.Right) {
                      return Effect_Class_Console.log(Effect_Class.monadEffectEffect)(Data_Show.show(Affjax_StatusCode.showStatusCode)(response.value0.status));
                  };
                  throw new Error("Failed pattern match at Blog (line 34, column 11 - line 36, column 43): " + [ response.constructor.name ]);
              })());
          });
      };
...
(function($PS) {
  ...
  var spaComponent = function (currentYear) {
      var renderActiveComponent = function (v) {
          ...
          throw new Error("Failed pattern match at SPA (line 52, column 27 - line 55, column 33): " + [ v.constructor.name ]);
      };
      var render = function (state) {
