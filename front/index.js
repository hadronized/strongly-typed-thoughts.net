...
(function($PS) {
  ...
  var navPart = (function () {
      var navItem = function (url) {
          return function (t) {
              return function (icon) {
                  return function (action) {
                      return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.title(t), HTMLHelper.cl([ "level-item" ]) ])(Data_Maybe.maybe([  ])(function ($7) {
                          return Data_Array.singleton(Halogen_HTML_Events.onClick(Data_Function["const"]($7)));
                      })(action)))([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "icon", "is-large" ]) ])([ Halogen_HTML_Elements.i([ HTMLHelper.cl([ "fa", icon ]) ])([  ]) ]) ]);
                  };
              };
          };
      };
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.id("top-header"), HTMLHelper.cl([ "hero", "is-medium" ]) ])([ Halogen_HTML_Elements.div([ HTMLHelper.cl([ "hero-body", "container", "level", "has-shadow" ]) ])([ Halogen_HTML_Elements.div([ HTMLHelper.cl([ "level-item", "has-text-centered" ]) ])([ Halogen_HTML_Elements.div([ HTMLHelper.cl([ "content" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Elements.h1([ HTMLHelper.cl([ "title", "is-1" ]) ])([ Halogen_HTML_Core.text("Dimitri Sabadie") ]) ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Elements.h2([ HTMLHelper.cl([ "subtitle", "is-4" ]) ])([ Halogen_HTML_Elements.em([  ])([ Halogen_HTML_Core.text("Do not make more tools than existing problems") ]) ]) ]) ]) ]), navItem("/")("phaazon.net")("fa-home")(Data_Maybe.Just.create(new Switch(AboutMe.value))), navItem("https://git.phaazon.net")("git.phaazon.net")("fa-code-fork")(Data_Maybe.Nothing.value), navItem("/blog")("/blog")("fa-pencil")(Data_Maybe.Just.create(new Switch(Blog.value))), navItem("/browse")("all the memes!")("fa-cloud-download")(Data_Maybe.Just.create(new Switch(Browse.value))) ]) ]);
  })();
  ...
  var spaComponent = function (currentYear) {
      var renderActiveComponent = function (v) {
          ...
          throw new Error("Failed pattern match at SPA (line 47, column 27 - line 50, column 33): " + [ v.constructor.name ]);
      };
      var initialState = function (v) {
