...
(function($PS) {
  ...
  var blogComponent = (function () {
      var render = function (v) {
          return Halogen_HTML_Core.text("lol");
      };
      var initialState = function (v) {
          return Data_Unit.unit;
      };
  ...
  var spaComponent = function (currentYear) {
      var renderActiveComponent = function (v) {
          ...
          if (v instanceof Blog) {
              return Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
                  return "blog";
              }))(Data_Ord.ordInt)(_blog)(0)(Blog_1.blogComponent)(Data_Unit.unit);
          };
          if (v instanceof Browse) {
              return Halogen_HTML_Core.text("Slot browse");
          };
          throw new Error("Failed pattern match at SPA (line 53, column 27 - line 56, column 33): " + [ v.constructor.name ]);
      };
      var initialState = function (v) {
      ...
      var activeComponent = function (state) {
          return Halogen_HTML_Elements.section([ HTMLHelper.cl([ "container", "section", "content" ]) ])([ renderActiveComponent(state) ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.div([  ])([ navPart, activeComponent(state), footerPart(currentYear) ]);
      };
      return Halogen_Component.mkComponent({
          "eval": $$eval,
          initialState: initialState,
