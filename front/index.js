...
(function($PS) {
                  ...
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Formatter_DateTime.unformatDateTime("YYYY-MM-DDTHH:mm:ssZ")(publishDateRaw))(function (publishDate) {
                      return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article tags")("article_tags")(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toArray)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Argonaut_Core.toString))))(function (tags) {
                          return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article slug")("article_slug")((function () {
                              var $45 = Data_Functor.map(Data_Maybe.functorMaybe)(Slug);
                              return function ($46) {
  ...
  var getArticleContent = function (dictMonadAff) {
      return function (v) {
          return Effect_Aff_Class.liftAff(dictMonadAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.bimap(Data_Bifunctor.bifunctorEither)(Affjax.printError)(function ($47) {
      ...
      return function (slug) {
          var switchToArticle = function (html) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $28.currentArticle = new Data_Maybe.Just(html);
                  return $28;
              });
          };
          ...
          var cache = function (html) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $34.articles = Data_Map_Internal.update(ordSlug)(function (article) {
                      return new Data_Maybe.Just((function () {
                          var $31 = {};
                          for (var $32 in article) {
                              if ({}.hasOwnProperty.call(article, $32)) {
                                  $31[$32] = article[$32];
                              };
                          };
                          $31.content = new Data_Maybe.Just(html);
                          return $31;
                      })());
                  })(slug)(state.articles);
                  return $34;
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
              var $48 = Data_Map_Internal.lookup(ordSlug)(slug);
              return function ($49) {
  ...
  var blogComponent = function (dictMonadAff) {
      ...
      var renderBlogList = function (state) {
          ...
          throw new Error("Failed pattern match at Blog (line 118, column 3 - line 120, column 72): " + [ state.constructor.name ]);
      };
      ...
      var render = function (state) {
          return Halogen_HTML_Elements.section([ HTMLHelper.cl([ "container", "section", "content" ]) ])((function () {
              if (state.currentArticle instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML.fromPlainHTML(state.currentArticle.value0) ];
              };
              if (state.currentArticle instanceof Data_Maybe.Nothing) {
                  return renderListing(state);
              };
              throw new Error("Failed pattern match at Blog (line 91, column 73 - line 93, column 35): " + [ state.currentArticle.constructor.name ]);
          })());
      };
      var initialState = function (v) {
          return {
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
                  ...
                  throw new Error("Failed pattern match at Blog (line 70, column 7 - line 85, column 45): " + [ response.constructor.name ]);
              });
          };
          if (v instanceof ReadArticle) {
              return readArticle(dictMonadAff)(v.value0);
          };
          throw new Error("Failed pattern match at Blog (line 67, column 18 - line 87, column 41): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var showActiveComponent = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at SPA (line 35, column 10 - line 38, column 23): " + [ v.constructor.name ]);
  });
  ...
  var spaComponent = function (currentYear) {
      var renderActiveComponent = function (v) {
          ...
          if (v.value0.component instanceof Blog) {
              return Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
                  return "blog";
              }))(Data_Ord.ordInt)(_blog)(0)(Blog_1.blogComponent(Effect_Aff_Class.monadAffAff))(Data_Unit.unit);
          };
          if (v.value0.component instanceof Browse) {
              return Halogen_HTML_Core.text("Slot browse");
          };
          throw new Error("Failed pattern match at SPA (line 72, column 41 - line 75, column 33): " + [ v.value0.component.constructor.name ]);
      };
      var render = function (state) {
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at SPA (line 55, column 18 - line 66, column 54): " + [ v.constructor.name ]);
      };
      var $$eval = Halogen_Component.mkEval({
          handleAction: handleAction,
          handleQuery: Halogen_Component.defaultEval.handleQuery,
