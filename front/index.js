...
(function($PS) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article publish date")("article_publish_date")(Data_Argonaut_Core.toString))(function (publishDateRaw) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Formatter_DateTime.unformatDateTime("YYYY-MM-DDTHH:mm:ssZ")(publishDateRaw))(function (publishDate) {
                      return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article tags")("article_tags")(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toArray)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Argonaut_Core.toString))))(function (tags) {
                          return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article slug")("article_slug")(Data_Argonaut_Core.toString))(function (slug) {
  ...
  var blogComponent = function (dictMonadAff) {
      var inlineBlogArticle = function (article) {
          return Halogen_HTML_Elements.div([ HTMLHelper.cl([ "level" ]) ])([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "level-left" ]) ])([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "level-item" ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/blog/" + article.metadata.slug) ])([ Halogen_HTML_Core.text(article.metadata.name) ]) ]) ]), Halogen_HTML_Elements.span([ HTMLHelper.cl([ "level-right" ]) ])([ Halogen_HTML_Elements.span([ HTMLHelper.cl([ "level-item" ]) ])([ Halogen_HTML_Elements.em_([ Halogen_HTML_Core.text("on " + formatTime(article.metadata.publishDate)) ]) ]) ]) ]);
      };
      var renderBlogList = function (state) {
          ...
          throw new Error("Failed pattern match at Blog (line 106, column 3 - line 108, column 72): " + [ state.constructor.name ]);
      };
      var render = function (state) {
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
          ...
          })(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Affjax.printError)))(Affjax.get(Affjax_ResponseFormat.json)("/api/v1/blog"))))(function (response) {
              ...
              if (response instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(Data_Show.show(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "name";
                      ...
                      return "tags";
                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showArray(Data_Show.showString)))(Data_Show.showString))(Data_DateTime.showDateTime))(Data_Show.showString))))(response.value0))))(function () {
              ...
              throw new Error("Failed pattern match at Blog (line 63, column 7 - line 78, column 29): " + [ response.constructor.name ]);
          });
      };
