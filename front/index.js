...
(function($PS) {
  ...
  var rootComponent = (function () {
      var render = function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("-1") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Increment.value;
          }) ])([ Halogen_HTML_Core.text("+1") ]) ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 38, column 20 - line 40, column 35): " + [ v.constructor.name ]);
      };
