...
(function($PS) {
  ...
  var spaComponent = function (currentYear) {
      var renderActiveComponent = function (v) {
          ...
          throw new Error("Failed pattern match at SPA (line 51, column 27 - line 54, column 33): " + [ v.constructor.name ]);
      };
      var render = function (state) {
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.history))(Web_HTML_History.pushState(Foreign.unsafeToForeign(Data_Unit.unit))("")(v.value1))))(function () {
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(SPA.spaComponent(year))(Data_Unit.unit)))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();