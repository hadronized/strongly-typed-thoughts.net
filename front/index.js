...
(function($PS) {
                  ...
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Formatter_DateTime.unformatDateTime("YYYY-MM-DDTHH:mm:ssZ")(publishDateRaw))(function (publishDate) {
                      return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article tags")("article_tags")(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toArray)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Argonaut_Core.toString))))(function (tags) {
                          return Control_Bind.bind(Data_Either.bindEither)(extractField("missing article slug")("article_slug")((function () {
                              var $75 = Data_Functor.map(Data_Maybe.functorMaybe)(Slug);
                              return function ($76) {
                                  return $75(Data_Argonaut_Core.toString($76));
                              };
                          })()))(function (slug) {
                              return Control_Applicative.pure(Data_Either.applicativeEither)({
                                  name: name,
  ...
  var inferSlug = function (dictMonadEffect) {
      var toSlug = function (p) {
          ...
          throw new Error("Failed pattern match at Blog (line 244, column 6 - line 246, column 29): " + [ p.constructor.name ]);
      };
      return Control_Bind.composeKleisli((dictMonadEffect.Monad0()).Bind1())(Router.path(dictMonadEffect))((function () {
          var $77 = Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0());
          return function ($78) {
              return $77(toSlug($78));
          };
      })());
  ...
  var getArticleContent = function (dictMonadAff) {
      return function (v) {
          return Effect_Aff_Class.liftAff(dictMonadAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.bimap(Data_Bifunctor.bifunctorEither)(Affjax.printError)(function ($79) {
  ...
  var cacheAndSwitch = function (metadata) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              if (article instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Blog (line 219, column 37 - line 221, column 43): " + [ article.value0.content.constructor.name ]);
              };
              if (article instanceof Data_Maybe.Nothing) {
                  return noSuchArticle("no such article: " + Data_Show.show(showSlug)(slug));
              };
              throw new Error("Failed pattern match at Blog (line 218, column 5 - line 222, column 66): " + [ article.constructor.name ]);
          });
      };
  };
  ...
  var blogComponent = function (dictMonadAff) {
      ...
      var renderBlogList = function (state) {
          ...
          throw new Error("Failed pattern match at Blog (line 158, column 3 - line 160, column 72): " + [ state.constructor.name ]);
      };
      ...
      var render = function (v) {
          ...
          throw new Error("Failed pattern match at Blog (line 110, column 26 - line 112, column 35): " + [ v.value0.currentArticle.constructor.name ]);
      };
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Functor.map(Effect_Aff.functorAff)(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function (res) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Blog (line 82, column 7 - line 96, column 100): " + [ response.constructor.name ]);
                  })())(function () {
          ...
          throw new Error("Failed pattern match at Blog (line 78, column 18 - line 102, column 41): " + [ v.constructor.name ]);
      };
