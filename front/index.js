...
(function($PS) {
  ...
  var tileComponent = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "tile-component" ])) ])([ Halogen_HTML_Core.text("petit test"), state ]);
      };
      var $$eval = Halogen_Component.mkEval(Halogen_Component.defaultEval);
      return Halogen_Component.mkComponent({
          "eval": $$eval,
          initialState: Halogen_HTML_Core.text,
          render: render
      });
  })();
...
(function($PS) {
  ...
  var Web_HTML_Common = $PS["Web.HTML.Common"];                
  var _tile = Type_Proxy["Proxy"].value;
  var rootComponent = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "tile-container" ])) ])([ Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "nested";
          }))(Data_Ord.ordInt)(_tile)(0)(Tile.tileComponent)("upper-left"), Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "nested";
          }))(Data_Ord.ordInt)(_tile)(1)(Tile.tileComponent)("upper-right"), Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "nested";
          }))(Data_Ord.ordInt)(_tile)(2)(Tile.tileComponent)("lower-left"), Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "nested";
          }))(Data_Ord.ordInt)(_tile)(3)(Tile.tileComponent)("lower-right") ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(rootComponent)(Data_Unit.unit)));
  exports["main"] = main;
  exports["_tile"] = _tile;
